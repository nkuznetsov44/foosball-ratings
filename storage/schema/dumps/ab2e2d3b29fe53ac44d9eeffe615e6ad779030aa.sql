...
CREATE TABLE public.competitions (
    ...
    cumulative_coefficient numeric,
...
--
-- Name: matches matches_competition_id_order_key; Type: CONSTRAINT; Schema: public; Owner: ratings
--

ALTER TABLE ONLY public.matches
    ADD CONSTRAINT matches_competition_id_order_key UNIQUE (competition_id, "order");
...
--
-- Name: sets sets_match_id_order_key; Type: CONSTRAINT; Schema: public; Owner: ratings
--

ALTER TABLE ONLY public.sets
    ADD CONSTRAINT sets_match_id_order_key UNIQUE (match_id, "order");
